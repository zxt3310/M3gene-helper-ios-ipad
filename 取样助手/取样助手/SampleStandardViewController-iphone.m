...
- (void)viewDidLoad {
    ...
    productCb = [[UIComboBox alloc] initWithFrame:CGRectMake(60*SCREEN_WEIGHT/375,
                                                                         227*SCREEN_HEIGHT/667,
                                                                         258*SCREEN_WEIGHT/375,
                                                                         33)];
    ...
    compositeView = [[UIView alloc] initWithFrame:CGRectMake(0, 200*SCREEN_HEIGHT/667, SCREEN_WEIGHT, 300*SCREEN_HEIGHT/667)];
    for (int i=0; i<_composite_prouductList.count; i++) {
        UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
        button.frame = CGRectMake(18*SCREEN_HEIGHT/375 + i%2*172*SCREEN_WEIGHT/375,1+i/2*100*SCREEN_HEIGHT/667, 142*SCREEN_WEIGHT/375, 80*SCREEN_HEIGHT/667);
...
- (void)addProductBtn:(UIButton *)sender{
    ...
    UIComboBox *productCbox = [[UIComboBox alloc] initWithFrame:CGRectMake(60*SCREEN_WEIGHT/375,
    ...
    productNo++;
    productCbox.tag = productNo+oringTag;
    NSLog(@"%ld",productCbox.tag);
}
    ...
    if (sigleBtn.selected == YES) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                SampleStandardCompositeProductViewController_iphone *SCPVC = [[SampleStandardCompositeProductViewController_iphone alloc] init];
